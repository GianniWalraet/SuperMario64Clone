...
#endif
#ifdef ExamProject
#include "Scenes/Exam/BobOmbBattlefieldScene.h"
#include "Scenes/Exam/MainMenuScene.h"
#include "Scenes/Exam/BobOmbRoomScene.h"
#include "Scenes/Exam/VictoryScene.h"
#include "Scenes/Exam/DefeatScene.h"
#endif
...
void MainGame::OnGamePreparing(GameContext& gameContext)
{
	...
	gameContext.windowTitle = L"GP2 - ExamProject | (2DAE14) Walraet Gianni";
}
...
void MainGame::Initialize()
{
	...
	SceneManager::Get()->AddGameScene(new BobOmbBattlefieldScene());
	SceneManager::Get()->AddGameScene(new BobOmbRoomScene());
	SceneManager::Get()->AddGameScene(new VictoryScene());
	SceneManager::Get()->AddGameScene(new DefeatScene());
#endif
}
